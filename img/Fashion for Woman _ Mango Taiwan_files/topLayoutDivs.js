$(document).ready(function () {
	...
	**************************/
	...
	$('.boton_menu_izquierda').click(function (e) {
		...
		if (navigator.userAgent.indexOf('Android') > 0 && navigator.userAgent.indexOf('GT-') > 0 && navigator.userAgent.indexOf('Mobile Safari') > 0 && $(window).width() < '703') {
			...
			$('#menu_lateral_izquierdo').css({
				'overflow-x': 'hidden'
			});
			$('#menu_lateral_izquierdo.menu_lateral_izquierdo_mov2').css({
				'overflow': 'auto'
			});
			$('#supercontainer').css({
	...
	**************************/
	...
	$('.texto_banner.showtooltip', '.listsContainer').hover(
		function () {
			$moreInfoDiv.addClass('hover');
		},
		function () {
			$moreInfoDiv.removeClass('hover');
		}
	);
	...
	**************************/
	...
	$('.izq_ultimo').click(function () {
		window.swiperUltimo.swipePrev();
	});
	$('.der_ultimo').click(function () {
		window.swiperUltimo.swipeNext();
	});
	...
	**************************/
	...
	if (navigator.userAgent.indexOf('MSIE 6') >= 0 || navigator.userAgent.indexOf('MSIE 7') >= 0) {
		...
		$('.brand_kids .level2 .columna:nth-child(3)').css({
			'margin-left': '0px',
			'position': 'absolute',
	...
	if (navigator.userAgent.indexOf('MSIE 8') >= 0 || navigator.userAgent.indexOf('MSIE 7') >= 0 || navigator.userAgent.indexOf('MSIE 6') >= 0) {
		...
		$('.sidebarBorderedBlock.row-fluid:nth-child(3)').css({
			'border-bottom': '0'
		});
	};
	if (!IE67) {
